...
const RegisterVerify = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/api/register-otp`,
        { code: otp }
      );
      toast.success(response.data.msg || "User Register Successfully");
  ...
  const ResendOTP = async () => {
    try {
      ...
      toast.success(response.data.message || "OTP sent to email successfully");
